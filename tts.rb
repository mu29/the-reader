# encoding: utf-8
# original source: https://github.com/c2h2/tts
require 'open-uri'
require 'uri'
...
module Tts
  ...
  def to_file lang, file_name=nil
    ...
    parts.each_index do |i|
      ...
      progress = (i * 70 / parts.size)
      print "#{'#' * progress}#{' ' * (70 - progress)} (#{progress * 100 / 70}%)\r"
    end
  end
